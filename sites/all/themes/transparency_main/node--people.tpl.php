...
<?php
if(isset($node->field_featured_image['und'][0])){
...
<div class="w-col w-col-3">
  <div class="teamcard">
      <img class="team-image" src="<?php print image_style_url($style, $img_url) ?>" width="150">
    ...
    <div class="team-drop w-dropdown" data-delay="0">
      ...
      <nav class="tea-drop-list w-dropdown-list" data-ix="dropown">
